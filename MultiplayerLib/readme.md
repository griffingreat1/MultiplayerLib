...
It is designed around a **small, explicit API surface** while still supporting multi-client real-time state synchronization.
...
Copy the `MultiplayerLib` folder into your project and import it as a normal Python package:
